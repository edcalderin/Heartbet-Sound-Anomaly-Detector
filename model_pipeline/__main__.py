...
from model_pipeline.utils import Utils
...
from model_pipeline.datasets import AudioDataset, AudioDatasetWithAugmentation
from model_pipeline.hearbet_detector_trainer import HearbetDetectorTrainer
...
class Train(BaseModel):
    ...
    def __call__(self) -> Any:
        ...
        dataframe: pd.DataFrame = Utils.create_dataframe(self.data_dir)
